...
import zhuoxin.andriody.com.gitdroid.git.NannerActivity;
import zhuoxin.andriody.com.gitdroid.git.mGifActivity;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public Demo[] setData() {
        data = new Demo[]{
                ...
                new Demo("轮播", new Intent(this, mGifActivity.class)),
                new Demo("轮播2", new Intent(this, NannerActivity.class))
        };
        return data;
    }
